...
### Challenge 2
In challenge 2 we are going to create a random genome function that is associated with the value of k -- this will allow us to define k to be different numerical values. This code block should give us a single genome string of the length k. 
